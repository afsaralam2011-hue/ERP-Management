...
const PVCcoatingPage = () => {
  ...
  const [reportData, setReportData] = useState({
    date: '',
    formattedDate: '',
    machineWise: {}, // Changed from coatingWise to machineWise
    shiftWise: {},
    finishedProductWise: {},
    totalProduction: 0,
    totalWeight: 0,
  ...
  const coatingTypes = [
    'Transparent PVC', 'White PVC', 'Black PVC',
    'Grey PVC', 'Color PVC', 'Special Coating',
    'UV Protected', 'Fire Retardant', 'Other'
  ];
  ...
  const handleExport = () => {
    ...
    const csvContent = [
      ['ID', 'Item Name', 'Raw Material Size', 'Material Type', 'Finished Product', 'Machine ID', 'Machine No', 'Production', 'Unit', 'Weight', 'Per Meter WT', 'Efficiency %', 'Operator', 'User Name', 'Shift Code', 'Shift Name', 'Remarks', 'Item Code', 'Section Name', 'Created At'],
  ...
  const uniqueCoatingTypes = [...new Set(
    records.map(record => record.material_type).filter(Boolean)
  )].sort();
  ...
  const uniqueShifts = [...new Set(
    records.map(record => record.shift_name).filter(Boolean)
  )].sort();
          ...
          <div className="title-section">
            ...
            <div>
              ...
              <p className="page-subtitle">
                <FiDatabase size={14} />
                Data from: pvcsection table • Total Records: {stats.totalRecords} • By: Afsar
              </p>
            </div>
          </div>
        </div>
          ...
          {productionSections.map((section) => (
            ...
            >
              <div className={`section-card ${section.id === 'pvc-coating' ? 'active' : ''}`}>
                <div className="section-card-highlight" style={{ 
                  background: section.id === 'pvc-coating' ? 'linear-gradient(90deg, #8b5cf6, #7c3aed)' : 'transparent' 
                }} />
                <div className="section-glow-right" />
                <div className="section-glow-left" />
                <div className="section-icon-container" style={{
              ...
              {Object.entries(stats.machineWiseToday).length > 0 ? (
                Object.entries(stats.machineWiseToday).map(([machine, data]) => (
                  <div key={machine} className="dashboard-card machine-card">
                    <div className="card-header">
                      <div className="card-icon" style={{ background: 'linear-gradient(135deg, #a78bfa 0%, #8b5cf6 100%)' }}>
                        <FiMachine size={14} />
                      </div>
              ...
              {Object.entries(stats.finishedProductWiseToday).length > 0 ? (
                Object.entries(stats.finishedProductWiseToday).map(([product, data]) => (
                  <div key={product} className="dashboard-card product-card">
                    <div className="card-header">
                      <div className="card-icon" style={{ background: 'linear-gradient(135deg, #c084fc 0%, #a855f7 100%)' }}>
                        <FiProduct size={14} />
                      </div>
      ...
      {showReport && reportData && (
        <div className="report-section">
                ...
                {Object.entries(reportData.machineWise).map(([machine, data]) => (
                  <div key={machine} className="machine-report-card">
                    <div className="machine-report-header">
                      <div className="machine-report-icon" style={{ background: 'linear-gradient(135deg, #a78bfa 0%, #8b5cf6 100%)' }}>
                        <FiMachine size={16} />
                      </div>
                      <div className="machine-report-name">Machine {machine}</div>
                    </div>
                ...
                {Object.entries(reportData.shiftWise).map(([shift, data]) => (
                  <div key={shift} className="shift-report-card">
                    <div className="shift-report-header">
                      <div className="shift-report-icon" style={{ background: 'linear-gradient(135deg, #06b6d4 0%, #0ea5e9 100%)' }}>
                        <FiWatch size={16} />
                      </div>
                ...
                {Object.entries(reportData.finishedProductWise).map(([product, data]) => (
                  <div key={product} className="finished-product-report-card">
                    <div className="finished-product-report-header">
                      <div className="finished-product-report-icon" style={{ background: 'linear-gradient(135deg, #c084fc 0%, #a855f7 100%)' }}>
                        <FiProduct size={16} />
                      </div>
          ...
          <div className="report-footer">
            Report generated on {new Date().toLocaleString()} by <strong>Afsar</strong> • Data source: pvcsection table
          </div>
        </div>
      )}
                    ...
                    >
                      ...
                      <td className="table-cell">
                        <div className="material-badge">
                          <div className="material-type" style={{ background: '#f5f3ff', color: '#7c3aed' }}>
                            {record.material_type || 'N/A'}
                          </div>
                        </div>
                      </td>
                      <td className="table-cell">
                        <div className="finished-product-badge" style={{ background: '#f3e8ff', color: '#7c3aed' }}>
                          {record.finishedproductname || 'N/A'}
                        </div>
                      </td>
                      <td className="table-cell">
                        <div className="machine-badge">
                          <div className="machine-info" style={{ color: '#8b5cf6' }}>
                      ...
                      <td className="table-cell production-cell">
                        <div className="production-badge">
                          <div className="production-value" style={{ color: '#8b5cf6' }}>
                      ...
                      <td className="table-cell weight-cell">
                        <div className="weight-badge">
                          <div className="weight-value" style={{ color: '#a78bfa' }}>
                          ...
                          {record.per_meter_wt && (
                            <div className="per-meter-wt" style={{ color: '#c084fc' }}>
                      ...
                      <td className="table-cell">
                        <div className="efficiency-badge">
                          <div className="efficiency-value" style={{ background: '#f3e8ff', color: '#8b5cf6' }}>
                      ...
                      <td className="table-cell">
                        <div className="operator-user-info">
                          <div className="operator-avatar" style={{ background: 'linear-gradient(135deg, #c084fc 0%, #a855f7 100%)' }}>
                      ...
                      <td className="table-cell">
                        <div className="shift-badge" style={{ background: '#f5f3ff', color: '#7c3aed' }}>
                          <div className="shift-info">
                            {record.shift_name || 'N/A'} 
                            {record.shift_code && (
                              <div className="shift-code" style={{ color: '#8b5cf6' }}>
        ...
        <div className="footer-content">
          <div>
            ...
            <div className="footer-subtitle">
              Database: pvcsection table • Last updated: {new Date().toLocaleTimeString()} • Managed by: Afsar
            </div>
          </div>
